...
const Appointment = (props) => {
    ...
    const makeAppointment = async() =>{
        ...
        let response = await axios.post('http://localhost:5000/appointment', appointmentData)
        let { error } = response.data
        if(error){
            setError(error)
            setTimeout( ()=>{
            ...
            <div className='appointment-container'>
                <div className='appointment-form'>
                    ...
                    <div className='appointment-inner-container'>
                        ...
                        : ''}
                        <p>Escolha uma data:<span className='red-astrix'>*</span></p>
                        <DatePicker
                            selected={startDate}
                    ...
                    <div className='appointment-inner-container'>
                        <p>Escolha uma hora:<span className='red-astrix'>*</span></p>
                        <Select
                   ...
                   <div id='appo-phone' className='appointment-inner-container'>
                        <p>Contacto: <span className='red-astrix'>*</span></p>
